...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("VisitsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheVisitsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheVisitsListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheVisitsListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheVisitsListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheVisitsListGenerated.onTable().iPressRow(0);
            Then.onTheVisitsObjectPageGenerated.iSeeThisPage();
